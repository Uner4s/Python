    ...
    if condicion1 == 1:
        ...
        while porcentaje_error <= norma:
            if iteraciones == 0:
                ...
                Y2 = float((b2-(a21*X1+a23*Z1))/a22)
                Z2 = float((b3-(a31*X1+a32*Y1))/a33)
    ...
    if condicion1 == 1:
        ...
        while porcentaje_error <= norma:
            if iteraciones == 0:
                ...
                Y2 = float((b2-(a21*X1 + a23*W1 + a24*Z1))/a22)
                W2 = float((b3-(a31*X1 + a32*Y1 + a34*Z1))/a33)
                Z2 = float((b4-(a41*X1 + a42*Y1 + a43*W1))/a44)
